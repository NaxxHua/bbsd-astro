...
const services = [
  {
    ...
    icon: (
      <svg className="h-[50px] w-[50px] text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          {services.map((service, i) => (
            <ScrollReveal key={service.title} delay={i * 0.1}>
              <a
                ...
                className="flex h-full flex-col items-start justify-center gap-[50px] rounded-[20px] bg-black/10 p-[30px] shadow-[0_0.6px_1.6px_-1px_rgba(0,0,0,0.15),0_2.3px_6px_-2px_rgba(0,0,0,0.14),0_10px_26px_-3px_rgba(0,0,0,0.1)] transition-colors hover:bg-black/25 lg:h-[315px]"
              >
                {service.icon}
